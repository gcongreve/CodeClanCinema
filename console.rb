...
screening1.save
screening2 = Screening.new({'film_id' => film2.id, 'start_time' => '12.00', 'tickets_left' => 2 })
screening2.save
screening3 = Screening.new({'film_id' => film1.id, 'start_time' => '14.00', 'tickets_left' => 2 })
screening3.save


customer1.buy_screening_ticket(screening1)
customer2.buy_screening_ticket(screening2)
customer1.buy_screening_ticket(screening2)
